...
#SBATCH --job-name=krill_batch2
#SBATCH --output=krill_batch2_%j.out
#SBATCH --error=krill_batch2_%j.err
...
WORK_DIR="/lustre09/project/6070433/peixiliu/Nanopore/Batch2"

RUN_ID="Batch2"

# Input files
SAMPLESHEET="${WORK_DIR}/batch2_samples.csv"

SUMMARY="/home/peixiliu/links/projects/rrg-lefranco/shared/Nanopore_Data/Sequencing_Summaries/sequencing_summary_run2_5.txt"
