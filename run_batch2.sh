...
# Input files stored inside WORK_DIR
...
# Output is written directly into WORK_DIR
OUTDIR="${WORK_DIR}"

# Nextflow intermediate files
NXF_WORK_DIR="${WORK_DIR}/nextflow_work"

# Logs generated by Nextflow
...
# Prepared JAFFAL reference
JAFFAL_REF_DIR="/lustre09/project/6066415/peixiliu/software/JAFFA_reference_hg38_gencode49"
