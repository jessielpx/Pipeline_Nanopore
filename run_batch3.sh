...
#SBATCH --job-name=krill_batch3
#SBATCH --output=krill_batch3_%j.out
#SBATCH --error=krill_batch3_%j.err
...
WORK_DIR="/lustre09/project/6070433/peixiliu/Nanopore/Batch3"

RUN_ID="batch3"

# Input files stored inside WORK_DIR
SAMPLESHEET="${WORK_DIR}/batch3_samples.csv"
SUMMARY="/home/peixiliu/links/projects/rrg-lefranco/shared/Nanopore_Data/Sequencing_Summaries/sequencing_summary_run3.txt"
